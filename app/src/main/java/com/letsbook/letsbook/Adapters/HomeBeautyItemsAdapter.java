...
public class HomeBeautyItemsAdapter extends RecyclerView.Adapter<HomeBeautyItemsAdapter.ViewHolder>{
    ...
    public HomeBeautyItemsAdapter(List<Response_HomeData.Category> beautyLists) {
        this.itemsList = beautyLists;
    }

    @Override
    public HomeBeautyItemsAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.items_view, viewGroup, false);

        return new HomeBeautyItemsAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(HomeBeautyItemsAdapter.ViewHolder viewHolder, int i) {
